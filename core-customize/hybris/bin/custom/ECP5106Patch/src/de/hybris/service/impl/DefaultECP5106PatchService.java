...
public class DefaultECP5106PatchService implements ECP5106PatchService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultECP5106PatchService.class);
	...
	{
		return DefaultECP5106PatchService.class.getResourceAsStream("/ECP5106Patch/sap-hybris-platform.png");
	}
